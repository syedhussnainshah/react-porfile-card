...
const Form = () => {
  ...
  return (
    <form>
      ...
      />
      <h1>Social Links</h1>
      <InputField label="linkedin" type="text" id="linkedin" name="linkedin" />
      <InputField label="twitter" type="text" id="twitter" name="twitter" />
      <InputField label="facebook" type="text" id="facebook" name="facebook" />
      <InputField
        label="instagram"
        type="text"
        id="instagram"
      ...
      <TextAreaField label="intrest" type="text" id="intrest" name="intrest" />
      <div>
